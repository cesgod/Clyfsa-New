...
<head>
    ...
    <title>CLYFSA | Consulta de Faccturas</title>
...
<body>
    ...
    <section class="not_found_area">
        <h2>Consulta de Exoneración</h2>
        <br><br>
        <img src="images/bill.svg" style="max-width: 50px;">
        <p style="padding-top: 10px">Según Ley Nº 6524/20 y su Decreto N° 3506/20</p><br>
        ...
        if ($_SESSION['conex']=='6524') {
         ...
         <a href="fact.php" class="btn btn-success " type="" style="width: 100%;"><h3>Consultar Factura</h3></a>
         </div>
         <br><br>
         </form>
