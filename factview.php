...
<body>
    ...
    <section class="not_found_area">
        <h2 style="color: #188bc9">Usuario<br> Nº. <?PHP echo $_SESSION['userm'];?></h2>
        <br>
        <a href="<?php echo $_SESSION['url'];?>" target="_blank"><img src="images/bill.svg" style="max-width: 100px"></a>
        <form class="search_error"><p style="font-size: 20px">Descargue su factura en PDF</p><br><br>
        <a href="<?php echo $_SESSION['url'];?>" class="btn btn-success" style="width: 100%"><h3>DESCARGAR <i class="far fa-file-pdf"></i></h3></a>
    </form>
