...
<body>
    ...
    <section class="not_found_area">
        ...
        <form action="dashboard/assets/php/response.php" class="search_error" method="post">
        <br>
        <input type="number" name="nromed" class="form-control" placeholder="Ingrese los 4 últimos números de medidor" required>
        ...
        <div class="row">
            ...
            <input type="text" name="tel" class="form-control" placeholder="Número de Celular" maxlength="6" required>
            </div>
            </div>
            <?php 
        
                echo '<h4 style="color:red;">'.$_SESSION['msg'].'</h4><br>';
