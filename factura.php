...
<head>
    ...
    <title>CLYFSA | Consultar Medidor</title>
...
$ban="no";
	...
	#if (!file_exists($file)) {
		#echo("WORKS");
		$link = '<a href="https://randomwsite.000webhostapp.com'.$file.'" target="_blank"><div style="background-color: aliceblue"><br><br><br><h3>DESCARGAR FACTURA</h3><br><br><br></div></a>';
		echo ($link);
	}else{
