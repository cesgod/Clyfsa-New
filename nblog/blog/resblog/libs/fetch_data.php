...
function getblogridposts($table){
	...
	if ($result=mysqli_query($con,$sql))
	{
		...
		foreach ($result as $bloggrid => $griditem) {
      	# code...
			echo '<div class="col-md-4 col-sm-6 blog_content">
			...
			<h4><small>Autor  </small>
			<a href="#">
			<i class="far fa-user"></i> '.$griditem['author'].'</a>

			<span>/</span><small>el </small> <a href="#">
			<i class="far fa-clock"></i>'.$griditem['date'].'</a></h4>
			<a href="#">
			...
			echo '	<div class="media">
			            <div class="media-left">
			                <a href="single.php?id='.$op['id'].'">
			                    <img class="media-object" src="blogadmin/images/'.$op['photo'].'" alt="" width="65px">
			                </a>
			            </div>
			            <div class="media-body">
			                <a href="single.php?id='.$op['id'].'">'.$op['title'].'</a>
			                <h6><i class="far fa-clock"></i> '.$op['date'].'</h6>
			            </div>
			        </div>';
