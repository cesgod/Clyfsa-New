            ...
            <div class="container">
                <div class="row book_now">
                    <div class="col-md-10 booking_text">
                        <h4>ENVIAR RECLAMOS</h4>
                        <p>VISUALIZAR ESTADÍSTICAS DE CONSUMO</p>
                    </div>
                    <div class="col-md-2 p0 book_bottun">
                        <a href="#" class="button_all">ENVIAR</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-3 col-sm-6 wow fadeInUp">
                   <div class="team_membar">
                        ...
                        <div class="team_content">
                            ...
                            <a href="#" class="name">Ing. Luis María Ocampos</a>
...
<a href="#" class="name">Lic. Gloria Alderete de Ocampos</a>
                ...
                <div class="col-md-3 col-sm-6 wow fadeInUp" data-wow-delay="0.4s">
                   <div class="team_membar">
                        ...
                        <div class="team_content">
                            ...
                            <a href="#" class="name">Abog. Arturo J. A. Casañas</a>
                            <h6>Secretario</h6>
                        </div>
                   </div>
                </div>
                <div class="col-md-3 col-sm-6 wow fadeInUp" data-wow-delay="0.6s">
                   <div class="team_membar">
                        ...
                        <div class="team_content">
                            ...
                            <a href="#" class="name">Sra. Nidia Valdez</a>
                            <h6>Tesorero</h6>
                        </div>
                   </div>
                </div>
